...
namespace Style {
	...
	constexpr Color headerGradColor(235.0f, 80.0f, 80.0f, 255.0f);
	...
	constexpr Vector2 featureNamePadding(8.0f, 8.0f);
	constexpr float featureHeight = 30.0f;
	constexpr Color featureHoverColor(100.0f, 100.0f, 100.0f, 180.0f);
	constexpr Color featureHoverGradColor(70.0f, 70.0f, 70.0f, 180.0f);
	constexpr Color featureTextActiveColor(255.0f, 100.0f, 100.0f, 255.0f);

	constexpr Vector2 settingsNamePadding(12.0f, 8.0f);

	constexpr Color recursiveColor(255.0f, 100.0f, 100.0f, 200.0f);
	constexpr Color recursiveGradColor(255.0f, 70.0f, 70.0f, 200.0f);
