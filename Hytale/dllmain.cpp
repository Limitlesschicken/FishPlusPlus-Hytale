...
bool InitSigs() {
	...
	GetMethodSigByRef(submitDrawCommands, "E8 ? ? ? ? E9 ? ? ? ? 0F 28 C1"); // E8 ? ? ? ? E9 ? ? ? ? 90 90 90 90 90 90 48 83 79
	...
	GetGlobalSigByRef(g_GlobalStateTable, "48 8D 05 ? ? ? ? 48 83 78 ? 00 0F 85 ? ? ? ? 48 8B 0D ? ? ? ? 48 8B 49 ? ? ? ? 4C 8B B1 ? ? ? ? 41 8B C8"); // 48 8D 05 ? ? ? ? 48 83 78 ? ? 0F 85 ? ? ? ? 48 8B 0D ? ? ? ? 48 8B 49 ? 45 8B 07
